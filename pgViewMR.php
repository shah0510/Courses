...
<head>
  ...
  <title>View MR Details | PharmTrades</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">MR Details</h4>
                  <p class="card-description" style="text-align:right;"><a href="pgAddMR.php"> + Add new record </a></p>
...
<script>
  ...
  function editRecord(id){
     window.location.href="pgEditMR.php?var="+id;		
	}
</script>	
</body>
