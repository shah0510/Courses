...
$qry="Select * from pt_company_details where id='".$var."'";  //getting the values
...
<head>
  ...
  <title>Edit Company Details | PharmTrades</title>
  <!-- plugins:css -->
...
<script>
  function save(){
			...
			if($("#txtName").val()==""){
				...
				$.ajax({
					type:"POST",
					url:"apiEditCompany.php",
					data:{name:$("#txtName").val(),mobileno:$("#txtMobileNumber").val(),email:$("#txtEmail").val(),id:id},
